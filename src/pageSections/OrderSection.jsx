...
const OrderSection = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen bg-gray-900 text-white">
      ...
      <aside
        className={`fixed bottom-14 left-0 w-full md:w-1/3 lg:w-1/4 bg-gray-800 p-4 transition-all duration-300 md:relative md:h-screen md:overflow-auto flex flex-col z-20 ${
