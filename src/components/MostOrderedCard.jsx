...
const MostOrderedCard = () => {
  ...
  return (
    <div className="bg-custom-dark-purple   p-4 rounded-lg shadow-lg hover:shadow-2xl transition duration-300 ease-in-out transform hover:scale-105 overflow-y-auto">
